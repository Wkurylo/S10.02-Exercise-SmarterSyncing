    ...
    synchronized public static void initialize(@NonNull final Context context) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                // To save memory. We are askiong only for one Column to check. This column is "not null"
                // If Table is not-empty, there shall be data.
                String[] projection = new String[]{WeatherContract.WeatherEntry._ID};

                Cursor checkSqlCursor = resolver.query(
                ...
                if (checkSqlCursor.getCount() == 0 || checkSqlCursor == null) {
                    startImmediateSync(context);
                }
                /* Make sure to close the Cursor to avoid memory leaks! */
                checkSqlCursor.close();
                return null;
            }
        }.execute();
    }
